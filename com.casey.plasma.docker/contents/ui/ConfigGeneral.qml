...
Kirigami.FormLayout {
    ...
    QQC2.Label {
        ...
        text: i18n("Theme uses Plasma's native frame. Translucent uses the selected opacity. Transparent removes all fill.")
        wrapMode: Text.Wrap
        opacity: 0.7
    ...
    QQC2.ComboBox {
        ...
        model: [i18n("Name"), i18n("Running first"), i18n("Docker order")]
    }
}
