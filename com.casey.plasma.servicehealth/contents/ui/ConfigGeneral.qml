...
Kirigami.FormLayout {
    ...
    property alias cfg_units: units.text
    ...
    QQC2.TextField {
        ...
        placeholderText: "tailscaled,docker,smbd,nmbd,cups"
    }

    QQC2.Label {
        Kirigami.FormData.isSection: true
        text: i18n("Comma-separated systemd unit names. \".service\" is added automatically if omitted.")
        wrapMode: Text.Wrap
        opacity: 0.7
        Layout.fillWidth: true
    }
